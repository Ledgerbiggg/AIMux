...
namespace AiMux.Common.Hotkey;

/// <summary>全局热键管理器（Win32 RegisterHotKey 封装，支持多个热键，每个有唯一 Id）
/// 注册成功后通过 HandleMessage 分发事件，外部订阅 HotkeyPressed 接收
/// 后续要加新的全局动作只需扩 HotkeyAction 枚举并在 MainWindow.WndProc 分发</summary>
public sealed class HotkeyManager : IDisposable
{
    ...
    /// <summary>注册一个全局热键；id 必须唯一（建议用 Hash 码或自增序号）
